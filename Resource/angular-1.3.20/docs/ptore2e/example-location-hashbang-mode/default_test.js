describe("", function() {
  ...
  beforeEach(function() {
    ...
    browser.get("build/docs/examples/example-location-hashbang-mode/home.html");
  });
  
var addressBar = element(by.css("#addressBar")),
     url = 'http://www.example.com/base/home.html#!/path?a=b#h';
...
it("should change $location accordingly", function(){
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/home.html#!/first?a=b");
  ...
  expect(addressBar.getAttribute('value')).toBe("http://www.example.com/base/home.html#!/sec/ond?flag#hash");
